...
}`;function gS(i,e,t){let n=new Ju;const s=new et,r=new et,o=new ot,a=new fS({depthPacking:Yg}),l=new hS,c={},u=t.maxTextureSize,d={[Ei]:dn,[dn]:Ei,[yt]:yt},f=new Ki({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new et},radius:{value:4}},vertexShader:pS,fragmentShader:mS}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const g=new Ct;g.setAttribute("position",new wt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new Ce(g,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=bh;let h=this.type;this.render=function(R,A,D){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||R.length===0)return;const T=i.getRenderTarget(),v=i.getActiveCubeFace(),C=i.getActiveMipmapLevel(),O=i.state;O.setBlending(Xi),O.buffers.color.setClear(1,1,1,1),O.buffers.depth.setTest(!0),O.setScissorTest(!1);const k=h!==yi&&this.type===yi,q=h===yi&&this.type!==yi;for(let Y=0,X=R.length;Y<X;Y++){const Q=R[Y],H=Q.shadow;if(H===void 0){console.warn("THREE.WebGLShadowMap:",Q,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;s.copy(H.mapSize);const te=H.getFrameExtents();if(s.multiply(te),r.copy(H.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/te.x),s.x=r.x*te.x,H.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/te.y),s.y=r.y*te.y,H.mapSize.y=r.y)),H.map===null||k===!0||q===!0){const be=this.type!==yi?{minFilter:tn,magFilter:tn}:{};H.map!==null&&H.map.dispose(),H.map=new Ls(s.x,s.y,be),H.map.texture.name=Q.name+".shadowMap",H.camera.updateProjectionMatrix()}i.setRenderTarget(H.map),i.clear();const pe=H.getViewportCount();for(let be=0;be<pe;be++){const qe=H.getViewport(be);o.set(r.x*qe.x,r.y*qe.y,r.x*qe.z,r.y*qe.w),O.viewport(o),H.updateMatrices(Q,be),n=H.getFrustum(),x(A,D,H.camera,Q,this.type)}H.isPointLightShadow!==!0&&this.type===yi&&b(H,D),H.needsUpdate=!1}h=this.type,m.needsUpdate=!1,i.setRenderTarget(T,v,C)};function b(R,A){const D=e.update(_);f.defines.VSM_SAMPLES!==R.blurSamples&&(f.defines.VSM_SAMPLES=R.blurSamples,p.defines.VSM_SAMPLES=R.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new Ls(s.x,s.y)),f.uniforms.shadow_pass.value=R.map.texture,f.uniforms.resolution.value=R.mapSize,f.uniforms.radius.value=R.radius,i.setRenderTarget(R.mapPass),i.clear(),i.renderBufferDirect(A,null,D,f,_,null),p.uniforms.shadow_pass.value=R.mapPass.texture,p.uniforms.resolution.value=R.mapSize,p.uniforms.radius.value=R.radius,i.setRenderTarget(R.map),i.clear(),i.renderBufferDirect(A,null,D,p,_,null)}function E(R,A,D,T){let v=null;const C=D.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(C!==void 0)v=C;else if(v=D.isPointLight===!0?l:a,i.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const O=v.uuid,k=A.uuid;let q=c[O];q===void 0&&(q={},c[O]=q);let Y=q[k];Y===void 0&&(Y=v.clone(),q[k]=Y,A.addEventListener("dispose",L)),v=Y}if(v.visible=A.visible,v.wireframe=A.wireframe,T===yi?v.side=A.shadowSide!==null?A.shadowSide:A.side:v.side=A.shadowSide!==null?A.shadowSide:d[A.side],v.alphaMap=A.alphaMap,v.alphaTest=A.alphaTest,v.map=A.map,v.clipShadows=A.clipShadows,v.clippingPlanes=A.clippingPlanes,v.clipIntersection=A.clipIntersection,v.displacementMap=A.displacementMap,v.displacementScale=A.displacementScale,v.displacementBias=A.displacementBias,v.wireframeLinewidth=A.wireframeLinewidth,v.linewidth=A.linewidth,D.isPointLight===!0&&v.isMeshDistanceMaterial===!0){const O=i.properties.get(v);O.light=D}return v}function x(R,A,D,T,v){if(R.visible===!1)return;if(R.layers.test(A.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&v===yi)&&(!R.frustumCulled||n.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(D.matrixWorldInverse,R.matrixWorld);const k=e.update(R),q=R.material;if(Array.isArray(q)){const Y=k.groups;for(let X=0,Q=Y.length;X<Q;X++){const H=Y[X],te=q[H.materialIndex];if(te&&te.visible){const pe=E(R,te,T,v);R.onBeforeShadow(i,R,A,D,k,pe,H),i.renderBufferDirect(D,null,k,pe,R,H),R.onAfterShadow(i,R,A,D,k,pe,H)}}}else if(q.visible){const Y=E(R,q,T,v);R.onBeforeShadow(i,R,A,D,k,Y,null),i.renderBufferDirect(D,null,k,Y,R,null),R.onAfterShadow(i,R,A,D,k,Y,null)}}const O=R.children;for(let k=0,q=O.length;k<q;k++)x(O[k],A,D,T,v)}function L(R){R.target.removeEventListener("dispose",L);for(const D in c){const T=c[D],v=R.target.uuid;v in T&&(T[v].dispose(),delete T[v])}}}const _S={[_c]:xc,[yc]:Mc,[vc]:Tc,[br]:Sc,[xc]:_c,[Mc]:yc,[Tc]:vc,[Sc]:br};function xS(i,e){function t(){let I=!1;const ce=new ot;let W=null;const Z=new ot(0,0,0,0);return{setMask:function(he){W!==he&&!I&&(i.colorMask(he,he,he,he),W=he)},setLocked:function(he){I=he},setClear:function(he,ue,Be,Tt,Kt){Kt===!0&&(he*=Tt,ue*=Tt,Be*=Tt),ce.set(he,ue,Be,Tt),Z.equals(ce)===!1&&(i.clearColor(he,ue,Be,Tt),Z.copy(ce))},reset:function(){I=!1,W=null,Z.set(-1,0,0,0)}}}function n(){let I=!1,ce=!1,W=null,Z=null,he=null;return{setReversed:function(ue){if(ce!==ue){const Be=e.get("EXT_clip_control");ce?Be.clipControlEXT(Be.LOWER_LEFT_EXT,Be.ZERO_TO_ONE_EXT):Be.clipControlEXT(Be.LOWER_LEFT_EXT,Be.NEGATIVE_ONE_TO_ONE_EXT);const Tt=he;he=null,this.setClear(Tt)}ce=ue},getReversed:function(){return ce},setTest:function(ue){ue?le(i.DEPTH_TEST):Pe(i.DEPTH_TEST)},setMask:function(ue){W!==ue&&!I&&(i.depthMask(ue),W=ue)},setFunc:function(ue){if(ce&&(ue=_S[ue]),Z!==ue){switch(ue){case _c:i.depthFunc(i.NEVER);break;case xc:i.depthFunc(i.ALWAYS);break;case yc:i.depthFunc(i.LESS);break;case br:i.depthFunc(i.LEQUAL);break;case vc:i.depthFunc(i.EQUAL);break;case Sc:i.depthFunc(i.GEQUAL);break;case Mc:i.depthFunc(i.GREATER);break;case Tc:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}Z=ue}},setLocked:function(ue){I=ue},setClear:function(ue){he!==ue&&(ce&&(ue=1-ue),i.clearDepth(ue),he=ue)},reset:function(){I=!1,W=null,Z=null,he=null,ce=!1}}}function s(){let I=!1,ce=null,W=null,Z=null,he=null,ue=null,Be=null,Tt=null,Kt=null;return{setTest:function(ct){I||(ct?le(i.STENCIL_TEST):Pe(i.STENCIL_TEST))},setMask:function(ct){ce!==ct&&!I&&(i.stencilMask(ct),ce=ct)},setFunc:function(ct,An,di){(W!==ct||Z!==An||he!==di)&&(i.stencilFunc(ct,An,di),W=ct,Z=An,he=di)},setOp:function(ct,An,di){(ue!==ct||Be!==An||Tt!==di)&&(i.stencilOp(ct,An,di),ue=ct,Be=An,Tt=di)},setLocked:function(ct){I=ct},setClear:function(ct){Kt!==ct&&(i.clearStencil(ct),Kt=ct)},reset:function(){I=!1,ce=null,W=null,Z=null,he=null,ue=null,Be=null,Tt=null,Kt=null}}}const r=new t,o=new n,a=new s,l=new WeakMap,c=new WeakMap;let u={},d={},f=new WeakMap,p=[],g=null,_=!1,m=null,h=null,b=null,E=null,x=null,L=null,R=null,A=new Fe(0,0,0),D=0,T=!1,v=null,C=null,O=null,k=null,q=null;const Y=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let X=!1,Q=0;const H=i.getParameter(i.VERSION);H.indexOf("WebGL")!==-1?(Q=parseFloat(/^WebGL (\d)/.exec(H)[1]),X=Q>=1):H.indexOf("OpenGL ES")!==-1&&(Q=parseFloat(/^OpenGL ES (\d)/.exec(H)[1]),X=Q>=2);let te=null,pe={};const be=i.getParameter(i.SCISSOR_BOX),qe=i.getParameter(i.VIEWPORT),nt=new ot().fromArray(be),K=new ot().fromArray(qe);function ee(I,ce,W,Z){const he=new Uint8Array(4),ue=i.createTexture();i.bindTexture(I,ue),i.texParameteri(I,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(I,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Be=0;Be<W;Be++)I===i.TEXTURE_3D||I===i.TEXTURE_2D_ARRAY?i.texImage3D(ce,0,i.RGBA,1,1,Z,0,i.RGBA,i.UNSIGNED_BYTE,he):i.texImage2D(ce+Be,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,he);return ue}const xe={};xe[i.TEXTURE_2D]=ee(i.TEXTURE_2D,i.TEXTURE_2D,1),xe[i.TEXTURE_CUBE_MAP]=ee(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),xe[i.TEXTURE_2D_ARRAY]=ee(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),xe[i.TEXTURE_3D]=ee(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),le(i.DEPTH_TEST),o.setFunc(br),Ye(!1),Le(Cd),le(i.CULL_FACE),F(Xi);function le(I){u[I]!==!0&&(i.enable(I),u[I]=!0)}function Pe(I){u[I]!==!1&&(i.disable(I),u[I]=!1)}function Ie(I,ce){return d[I]!==ce?(i.bindFramebuffer(I,ce),d[I]=ce,I===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=ce),I===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=ce),!0):!1}function Oe(I,ce){let W=p,Z=!1;if(I){W=f.get(ce),W===void 0&&(W=[],f.set(ce,W));const he=I.textures;if(W.length!==he.length||W[0]!==i.COLOR_ATTACHMENT0){for(let ue=0,Be=he.length;ue<Be;ue++)W[ue]=i.COLOR_ATTACHMENT0+ue;W.length=he.length,Z=!0}}else W[0]!==i.BACK&&(W[0]=i.BACK,Z=!0);Z&&i.drawBuffers(W)}function $e(I){return g!==I?(i.useProgram(I),g=I,!0):!1}const Ze={[_s]:i.FUNC_ADD,[_g]:i.FUNC_SUBTRACT,[xg]:i.FUNC_REVERSE_SUBTRACT};Ze[yg]=i.MIN,Ze[vg]=i.MAX;const Mt={[Sg]:i.ZERO,[Mg]:i.ONE,[Tg]:i.SRC_COLOR,[mc]:i.SRC_ALPHA,[Cg]:i.SRC_ALPHA_SATURATE,[Ag]:i.DST_COLOR,[Eg]:i.DST_ALPHA,[bg]:i.ONE_MINUS_SRC_COLOR,[gc]:i.ONE_MINUS_SRC_ALPHA,[Rg]:i.ONE_MINUS_DST_COLOR,[wg]:i.ONE_MINUS_DST_ALPHA,[Pg]:i.CONSTANT_COLOR,[Dg]:i.ONE_MINUS_CONSTANT_COLOR,[Lg]:i.CONSTANT_ALPHA,[Ig]:i.ONE_MINUS_CONSTANT_ALPHA};function F(I,ce,W,Z,he,ue,Be,Tt,Kt,ct){if(I===Xi){_===!0&&(Pe(i.BLEND),_=!1);return}if(_===!1&&(le(i.BLEND),_=!0),I!==gg){if(I!==m||ct!==T){if((h!==_s||x!==_s)&&(i.blendEquation(i.FUNC_ADD),h=_s,x=_s),ct)switch(I){case dr:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Pd:i.blendFunc(i.ONE,i.ONE);break;case Dd:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Ld:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",I);break}else switch(I){case dr:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Pd:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Dd:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Ld:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",I);break}b=null,E=null,L=null,R=null,A.set(0,0,0),D=0,m=I,T=ct}return}he=he||ce,ue=ue||W,Be=Be||Z,(ce!==h||he!==x)&&(i.blendEquationSeparate(Ze[ce],Ze[he]),h=ce,x=he),(W!==b||Z!==E||ue!==L||Be!==R)&&(i.blendFuncSeparate(Mt[W],Mt[Z],Mt[ue],Mt[Be]),b=W,E=Z,L=ue,R=Be),(Tt.equals(A)===!1||Kt!==D)&&(i.blendColor(Tt.r,Tt.g,Tt.b,Kt),A.copy(Tt),D=Kt),m=I,T=!1}function It(I,ce){I.side===yt?Pe(i.CULL_FACE):le(i.CULL_FACE);let W=I.side===dn;ce&&(W=!W),Ye(W),I.blending===dr&&I.transparent===!1?F(Xi):F(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),o.setFunc(I.depthFunc),o.setTest(I.depthTest),o.setMask(I.depthWrite),r.setMask(I.colorWrite);const Z=I.stencilWrite;a.setTest(Z),Z&&(a.setMask(I.stencilWriteMask),a.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),a.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),ht(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?le(i.SAMPLE_ALPHA_TO_COVERAGE):Pe(i.SAMPLE_ALPHA_TO_COVERAGE)}function Ye(I){v!==I&&(I?i.frontFace(i.CW):i.frontFace(i.CCW),v=I)}function Le(I){I!==pg?(le(i.CULL_FACE),I!==C&&(I===Cd?i.cullFace(i.BACK):I===mg?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Pe(i.CULL_FACE),C=I}function Re(I){I!==O&&(X&&i.lineWidth(I),O=I)}function ht(I,ce,W){I?(le(i.POLYGON_OFFSET_FILL),(k!==ce||q!==W)&&(i.polygonOffset(ce,W),k=ce,q=W)):Pe(i.POLYGON_OFFSET_FILL)}function we(I){I?le(i.SCISSOR_TEST):Pe(i.SCISSOR_TEST)}function w(I){I===void 0&&(I=i.TEXTURE0+Y-1),te!==I&&(i.activeTexture(I),te=I)}function y(I,ce,W){W===void 0&&(te===null?W=i.TEXTURE0+Y-1:W=te);let Z=pe[W];Z===void 0&&(Z={type:void 0,texture:void 0},pe[W]=Z),(Z.type!==I||Z.texture!==ce)&&(te!==W&&(i.activeTexture(W),te=W),i.bindTexture(I,ce||xe[I]),Z.type=I,Z.texture=ce)}function z(){const I=pe[te];I!==void 0&&I.type!==void 0&&(i.bindTexture(I.type,null),I.type=void 0,I.texture=void 0)}function j(){try{i.compressedTexImage2D.apply(i,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function J(){try{i.compressedTexImage3D.apply(i,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function $(){try{i.texSubImage2D.apply(i,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function ye(){try{i.texSubImage3D.apply(i,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function re(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function fe(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function Ke(){try{i.texStorage2D.apply(i,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function ne(){try{i.texStorage3D.apply(i,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function ae(){try{i.texImage2D.apply(i,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function Ee(){try{i.texImage3D.apply(i,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function Ue(I){nt.equals(I)===!1&&(i.scissor(I.x,I.y,I.z,I.w),nt.copy(I))}function _e(I){K.equals(I)===!1&&(i.viewport(I.x,I.y,I.z,I.w),K.copy(I))}function tt(I,ce){let W=c.get(ce);W===void 0&&(W=new WeakMap,c.set(ce,W));let Z=W.get(I);Z===void 0&&(Z=i.getUniformBlockIndex(ce,I.name),W.set(I,Z))}function He(I,ce){const Z=c.get(ce).get(I);l.get(ce)!==Z&&(i.uniformBlockBinding(ce,Z,I.__bindingPointIndex),l.set(ce,Z))}function mt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),u={},te=null,pe={},d={},f=new WeakMap,p=[],g=null,_=!1,m=null,h=null,b=null,E=null,x=null,L=null,R=null,A=new Fe(0,0,0),D=0,T=!1,v=null,C=null,O=null,k=null,q=null,nt.set(0,0,i.canvas.width,i.canvas.height),K.set(0,0,i.canvas.width,i.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:le,disable:Pe,bindFramebuffer:Ie,drawBuffers:Oe,useProgram:$e,setBlending:F,setMaterial:It,setFlipSided:Ye,setCullFace:Le,setLineWidth:Re,setPolygonOffset:ht,setScissorTest:we,activeTexture:w,bindTexture:y,unbindTexture:z,compressedTexImage2D:j,compressedTexImage3D:J,texImage2D:ae,texImage3D:Ee,updateUBOMapping:tt,uniformBlockBinding:He,texStorage2D:Ke,texStorage3D:ne,texSubImage2D:$,texSubImage3D:ye,compressedTexSubImage2D:re,compressedTexSubImage3D:fe,scissor:Ue,viewport:_e,reset:mt}}function Df(i,e,t,n){const s=yS(n);switch(t){case Lh:return i*e;case Uh:return i*e;case Nh:return i*e*2;case Yu:return i*e/s.components*s.byteLength;case Ku:return i*e/s.components*s.byteLength;case Fh:return i*e*2/s.components*s.byteLength;case ju:return i*e*2/s.components*s.byteLength;case Ih:return i*e*3/s.components*s.byteLength;case wn:return i*e*4/s.components*s.byteLength;case $u:return i*e*4/s.components*s.byteLength;case Ma:case Ta:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case ba:case Ea:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Ac:case Cc:return Math.max(i,16)*Math.max(e,8)/4;case wc:case Rc:return Math.max(i,8)*Math.max(e,8)/2;case Pc:case Dc:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case Lc:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Ic:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Uc:return Math.floor((i+4)/5)*Math.floor((e+3)/4)*16;case Nc:return Math.floor((i+4)/5)*Math.floor((e+4)/5)*16;case Fc:return Math.floor((i+5)/6)*Math.floor((e+4)/5)*16;case Oc:return Math.floor((i+5)/6)*Math.floor((e+5)/6)*16;case Bc:return Math.floor((i+7)/8)*Math.floor((e+4)/5)*16;case kc:return Math.floor((i+7)/8)*Math.floor((e+5)/6)*16;case zc:return Math.floor((i+7)/8)*Math.floor((e+7)/8)*16;case Vc:return Math.floor((i+9)/10)*Math.floor((e+4)/5)*16;case Gc:return Math.floor((i+9)/10)*Math.floor((e+5)/6)*16;case Hc:return Math.floor((i+9)/10)*Math.floor((e+7)/8)*16;case Wc:return Math.floor((i+9)/10)*Math.floor((e+9)/10)*16;case Xc:return Math.floor((i+11)/12)*Math.floor((e+9)/10)*16;case qc:return Math.floor((i+11)/12)*Math.floor((e+11)/12)*16;case wa:case Yc:case Kc:return Math.ceil(i/4)*Math.ceil(e/4)*16;case Oh:case jc:return Math.ceil(i/4)*Math.ceil(e/4)*8;case $c:case Zc:return Math.ceil(i/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function yS(i){switch(i){case wi:case Ch:return{byteLength:1,components:1};case yo:case Ph:case Io:return{byteLength:2,components:1};case Xu:case qu:return{byteLength:2,components:4};case Ds:case Wu:case Gn:return{byteLength:4,components:1};case Dh:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function vS(i,e,t,n,s,r,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new et,u=new WeakMap;let d;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(w,y){return p?new OffscreenCanvas(w,y):Mo("canvas")}function _(w,y,z){let j=1;const J=we(w);if((J.width>z||J.height>z)&&(j=z/Math.max(J.width,J.height)),j<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const $=Math.floor(j*J.width),ye=Math.floor(j*J.height);d===void 0&&(d=g($,ye));const re=y?g($,ye):d;return re.width=$,re.height=ye,re.getContext("2d").drawImage(w,0,0,$,ye),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+$+"x"+ye+")."),re}else return"data"in w&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),w;return w}function m(w){return w.generateMipmaps}function h(w){i.generateMipmap(w)}function b(w){return w.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:w.isWebGL3DRenderTarget?i.TEXTURE_3D:w.isWebGLArrayRenderTarget||w.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function E(w,y,z,j,J=!1){if(w!==null){if(i[w]!==void 0)return i[w];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let $=y;if(y===i.RED&&(z===i.FLOAT&&($=i.R32F),z===i.HALF_FLOAT&&($=i.R16F),z===i.UNSIGNED_BYTE&&($=i.R8)),y===i.RED_INTEGER&&(z===i.UNSIGNED_BYTE&&($=i.R8UI),z===i.UNSIGNED_SHORT&&($=i.R16UI),z===i.UNSIGNED_INT&&($=i.R32UI),z===i.BYTE&&($=i.R8I),z===i.SHORT&&($=i.R16I),z===i.INT&&($=i.R32I)),y===i.RG&&(z===i.FLOAT&&($=i.RG32F),z===i.HALF_FLOAT&&($=i.RG16F),z===i.UNSIGNED_BYTE&&($=i.RG8)),y===i.RG_INTEGER&&(z===i.UNSIGNED_BYTE&&($=i.RG8UI),z===i.UNSIGNED_SHORT&&($=i.RG16UI),z===i.UNSIGNED_INT&&($=i.RG32UI),z===i.BYTE&&($=i.RG8I),z===i.SHORT&&($=i.RG16I),z===i.INT&&($=i.RG32I)),y===i.RGB_INTEGER&&(z===i.UNSIGNED_BYTE&&($=i.RGB8UI),z===i.UNSIGNED_SHORT&&($=i.RGB16UI),z===i.UNSIGNED_INT&&($=i.RGB32UI),z===i.BYTE&&($=i.RGB8I),z===i.SHORT&&($=i.RGB16I),z===i.INT&&($=i.RGB32I)),y===i.RGBA_INTEGER&&(z===i.UNSIGNED_BYTE&&($=i.RGBA8UI),z===i.UNSIGNED_SHORT&&($=i.RGBA16UI),z===i.UNSIGNED_INT&&($=i.RGBA32UI),z===i.BYTE&&($=i.RGBA8I),z===i.SHORT&&($=i.RGBA16I),z===i.INT&&($=i.RGBA32I)),y===i.RGB&&z===i.UNSIGNED_INT_5_9_9_9_REV&&($=i.RGB9_E5),y===i.RGBA){const ye=J?ul:Qe.getTransfer(j);z===i.FLOAT&&($=i.RGBA32F),z===i.HALF_FLOAT&&($=i.RGBA16F),z===i.UNSIGNED_BYTE&&($=ye===ft?i.SRGB8_ALPHA8:i.RGBA8),z===i.UNSIGNED_SHORT_4_4_4_4&&($=i.RGBA4),z===i.UNSIGNED_SHORT_5_5_5_1&&($=i.RGB5_A1)}return($===i.R16F||$===i.R32F||$===i.RG16F||$===i.RG32F||$===i.RGBA16F||$===i.RGBA32F)&&e.get("EXT_color_buffer_float"),$}function x(w,y){let z;return w?y===null||y===Ds||y===Rr?z=i.DEPTH24_STENCIL8:y===Gn?z=i.DEPTH32F_STENCIL8:y===yo&&(z=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):y===null||y===Ds||y===Rr?z=i.DEPTH_COMPONENT24:y===Gn?z=i.DEPTH_COMPONENT32F:y===yo&&(z=i.DEPTH_COMPONENT16),z}function L(w,y){return m(w)===!0||w.isFramebufferTexture&&w.minFilter!==tn&&w.minFilter!==Et?Math.log2(Math.max(y.width,y.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?y.mipmaps.length:1}function R(w){const y=w.target;y.removeEventListener("dispose",R),D(y),y.isVideoTexture&&u.delete(y)}function A(w){const y=w.target;y.removeEventListener("dispose",A),v(y)}function D(w){const y=n.get(w);if(y.__webglInit===void 0)return;const z=w.source,j=f.get(z);if(j){const J=j[y.__cacheKey];J.usedTimes--,J.usedTimes===0&&T(w),Object.keys(j).length===0&&f.delete(z)}n.remove(w)}function T(w){const y=n.get(w);i.deleteTexture(y.__webglTexture);const z=w.source,j=f.get(z);delete j[y.__cacheKey],o.memory.textures--}function v(w){const y=n.get(w);if(w.depthTexture&&(w.depthTexture.dispose(),n.remove(w.depthTexture)),w.isWebGLCubeRenderTarget)for(let j=0;j<6;j++){if(Array.isArray(y.__webglFramebuffer[j]))for(let J=0;J<y.__webglFramebuffer[j].length;J++)i.deleteFramebuffer(y.__webglFramebuffer[j][J]);else i.deleteFramebuffer(y.__webglFramebuffer[j]);y.__webglDepthbuffer&&i.deleteRenderbuffer(y.__webglDepthbuffer[j])}else{if(Array.isArray(y.__webglFramebuffer))for(let j=0;j<y.__webglFramebuffer.length;j++)i.deleteFramebuffer(y.__webglFramebuffer[j]);else i.deleteFramebuffer(y.__webglFramebuffer);if(y.__webglDepthbuffer&&i.deleteRenderbuffer(y.__webglDepthbuffer),y.__webglMultisampledFramebuffer&&i.deleteFramebuffer(y.__webglMultisampledFramebuffer),y.__webglColorRenderbuffer)for(let j=0;j<y.__webglColorRenderbuffer.length;j++)y.__webglColorRenderbuffer[j]&&i.deleteRenderbuffer(y.__webglColorRenderbuffer[j]);y.__webglDepthRenderbuffer&&i.deleteRenderbuffer(y.__webglDepthRenderbuffer)}const z=w.textures;for(let j=0,J=z.length;j<J;j++){const $=n.get(z[j]);$.__webglTexture&&(i.deleteTexture($.__webglTexture),o.memory.textures--),n.remove(z[j])}n.remove(w)}let C=0;function O(){C=0}function k(){const w=C;return w>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+s.maxTextures),C+=1,w}function q(w){const y=[];return y.push(w.wrapS),y.push(w.wrapT),y.push(w.wrapR||0),y.push(w.magFilter),y.push(w.minFilter),y.push(w.anisotropy),y.push(w.internalFormat),y.push(w.format),y.push(w.type),y.push(w.generateMipmaps),y.push(w.premultiplyAlpha),y.push(w.flipY),y.push(w.unpackAlignment),y.push(w.colorSpace),y.join()}function Y(w,y){const z=n.get(w);if(w.isVideoTexture&&Re(w),w.isRenderTargetTexture===!1&&w.version>0&&z.__version!==w.version){const j=w.image;if(j===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(j.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{K(z,w,y);return}}t.bindTexture(i.TEXTURE_2D,z.__webglTexture,i.TEXTURE0+y)}function X(w,y){const z=n.get(w);if(w.version>0&&z.__version!==w.version){K(z,w,y);return}t.bindTexture(i.TEXTURE_2D_ARRAY,z.__webglTexture,i.TEXTURE0+y)}function Q(w,y){const z=n.get(w);if(w.version>0&&z.__version!==w.version){K(z,w,y);return}t.bindTexture(i.TEXTURE_3D,z.__webglTexture,i.TEXTURE0+y)}function H(w,y){const z=n.get(w);if(w.version>0&&z.__version!==w.version){ee(z,w,y);return}t.bindTexture(i.TEXTURE_CUBE_MAP,z.__webglTexture,i.TEXTURE0+y)}const te={[Ar]:i.REPEAT,[Vi]:i.CLAMP_TO_EDGE,[La]:i.MIRRORED_REPEAT},pe={[tn]:i.NEAREST,[Rh]:i.NEAREST_MIPMAP_NEAREST,[ao]:i.NEAREST_MIPMAP_LINEAR,[Et]:i.LINEAR,[Sa]:i.LINEAR_MIPMAP_NEAREST,[Mi]:i.LINEAR_MIPMAP_LINEAR},be={[jg]:i.NEVER,[t0]:i.ALWAYS,[$g]:i.LESS,[zh]:i.LEQUAL,[Zg]:i.EQUAL,[e0]:i.GEQUAL,[Qg]:i.GREATER,[Jg]:i.NOTEQUAL};function qe(w,y){if(y.type===Gn&&e.has("OES_texture_float_linear")===!1&&(y.magFilter===Et||y.magFilter===Sa||y.magFilter===ao||y.magFilter===Mi||y.minFilter===Et||y.minFilter===Sa||y.minFilter===ao||y.minFilter===Mi)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(w,i.TEXTURE_WRAP_S,te[y.wrapS]),i.texParameteri(w,i.TEXTURE_WRAP_T,te[y.wrapT]),(w===i.TEXTURE_3D||w===i.TEXTURE_2D_ARRAY)&&i.texParameteri(w,i.TEXTURE_WRAP_R,te[y.wrapR]),i.texParameteri(w,i.TEXTURE_MAG_FILTER,pe[y.magFilter]),i.texParameteri(w,i.TEXTURE_MIN_FILTER,pe[y.minFilter]),y.compareFunction&&(i.texParameteri(w,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(w,i.TEXTURE_COMPARE_FUNC,be[y.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(y.magFilter===tn||y.minFilter!==ao&&y.minFilter!==Mi||y.type===Gn&&e.has("OES_texture_float_linear")===!1)return;if(y.anisotropy>1||n.get(y).__currentAnisotropy){const z=e.get("EXT_texture_filter_anisotropic");i.texParameterf(w,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(y.anisotropy,s.getMaxAnisotropy())),n.get(y).__currentAnisotropy=y.anisotropy}}}function nt(w,y){let z=!1;w.__webglInit===void 0&&(w.__webglInit=!0,y.addEventListener("dispose",R));const j=y.source;let J=f.get(j);J===void 0&&(J={},f.set(j,J));const $=q(y);if($!==w.__cacheKey){J[$]===void 0&&(J[$]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,z=!0),J[$].usedTimes++;const ye=J[w.__cacheKey];ye!==void 0&&(J[w.__cacheKey].usedTimes--,ye.usedTimes===0&&T(y)),w.__cacheKey=$,w.__webglTexture=J[$].texture}return z}function K(w,y,z){let j=i.TEXTURE_2D;(y.isDataArrayTexture||y.isCompressedArrayTexture)&&(j=i.TEXTURE_2D_ARRAY),y.isData3DTexture&&(j=i.TEXTURE_3D);const J=nt(w,y),$=y.source;t.bindTexture(j,w.__webglTexture,i.TEXTURE0+z);const ye=n.get($);if($.version!==ye.__version||J===!0){t.activeTexture(i.TEXTURE0+z);const re=Qe.getPrimaries(Qe.workingColorSpace),fe=y.colorSpace===ki?null:Qe.getPrimaries(y.colorSpace),Ke=y.colorSpace===ki||re===fe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,y.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,y.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ke);let ne=_(y.image,!1,s.maxTextureSize);ne=ht(y,ne);const ae=r.convert(y.format,y.colorSpace),Ee=r.convert(y.type);let Ue=E(y.internalFormat,ae,Ee,y.colorSpace,y.isVideoTexture);qe(j,y);let _e;const tt=y.mipmaps,He=y.isVideoTexture!==!0,mt=ye.__version===void 0||J===!0,I=$.dataReady,ce=L(y,ne);if(y.isDepthTexture)Ue=x(y.format===Cr,y.type),mt&&(He?t.texStorage2D(i.TEXTURE_2D,1,Ue,ne.width,ne.height):t.texImage2D(i.TEXTURE_2D,0,Ue,ne.width,ne.height,0,ae,Ee,null));else if(y.isDataTexture)if(tt.length>0){He&&mt&&t.texStorage2D(i.TEXTURE_2D,ce,Ue,tt[0].width,tt[0].height);for(let W=0,Z=tt.length;W<Z;W++)_e=tt[W],He?I&&t.texSubImage2D(i.TEXTURE_2D,W,0,0,_e.width,_e.height,ae,Ee,_e.data):t.texImage2D(i.TEXTURE_2D,W,Ue,_e.width,_e.height,0,ae,Ee,_e.data);y.generateMipmaps=!1}else He?(mt&&t.texStorage2D(i.TEXTURE_2D,ce,Ue,ne.width,ne.height),I&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ne.width,ne.height,ae,Ee,ne.data)):t.texImage2D(i.TEXTURE_2D,0,Ue,ne.width,ne.height,0,ae,Ee,ne.data);else if(y.isCompressedTexture)if(y.isCompressedArrayTexture){He&&mt&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ce,Ue,tt[0].width,tt[0].height,ne.depth);for(let W=0,Z=tt.length;W<Z;W++)if(_e=tt[W],y.format!==wn)if(ae!==null)if(He){if(I)if(y.layerUpdates.size>0){const he=Df(_e.width,_e.height,y.format,y.type);for(const ue of y.layerUpdates){const Be=_e.data.subarray(ue*he/_e.data.BYTES_PER_ELEMENT,(ue+1)*he/_e.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,W,0,0,ue,_e.width,_e.height,1,ae,Be)}y.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,W,0,0,0,_e.width,_e.height,ne.depth,ae,_e.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,W,Ue,_e.width,_e.height,ne.depth,0,_e.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else He?I&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,W,0,0,0,_e.width,_e.height,ne.depth,ae,Ee,_e.data):t.texImage3D(i.TEXTURE_2D_ARRAY,W,Ue,_e.width,_e.height,ne.depth,0,ae,Ee,_e.data)}else{He&&mt&&t.texStorage2D(i.TEXTURE_2D,ce,Ue,tt[0].width,tt[0].height);for(let W=0,Z=tt.length;W<Z;W++)_e=tt[W],y.format!==wn?ae!==null?He?I&&t.compressedTexSubImage2D(i.TEXTURE_2D,W,0,0,_e.width,_e.height,ae,_e.data):t.compressedTexImage2D(i.TEXTURE_2D,W,Ue,_e.width,_e.height,0,_e.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):He?I&&t.texSubImage2D(i.TEXTURE_2D,W,0,0,_e.width,_e.height,ae,Ee,_e.data):t.texImage2D(i.TEXTURE_2D,W,Ue,_e.width,_e.height,0,ae,Ee,_e.data)}else if(y.isDataArrayTexture)if(He){if(mt&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ce,Ue,ne.width,ne.height,ne.depth),I)if(y.layerUpdates.size>0){const W=Df(ne.width,ne.height,y.format,y.type);for(const Z of y.layerUpdates){const he=ne.data.subarray(Z*W/ne.data.BYTES_PER_ELEMENT,(Z+1)*W/ne.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,Z,ne.width,ne.height,1,ae,Ee,he)}y.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,ne.width,ne.height,ne.depth,ae,Ee,ne.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Ue,ne.width,ne.height,ne.depth,0,ae,Ee,ne.data);else if(y.isData3DTexture)He?(mt&&t.texStorage3D(i.TEXTURE_3D,ce,Ue,ne.width,ne.height,ne.depth),I&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,ne.width,ne.height,ne.depth,ae,Ee,ne.data)):t.texImage3D(i.TEXTURE_3D,0,Ue,ne.width,ne.height,ne.depth,0,ae,Ee,ne.data);else if(y.isFramebufferTexture){if(mt)if(He)t.texStorage2D(i.TEXTURE_2D,ce,Ue,ne.width,ne.height);else{let W=ne.width,Z=ne.height;for(let he=0;he<ce;he++)t.texImage2D(i.TEXTURE_2D,he,Ue,W,Z,0,ae,Ee,null),W>>=1,Z>>=1}}else if(tt.length>0){if(He&&mt){const W=we(tt[0]);t.texStorage2D(i.TEXTURE_2D,ce,Ue,W.width,W.height)}for(let W=0,Z=tt.length;W<Z;W++)_e=tt[W],He?I&&t.texSubImage2D(i.TEXTURE_2D,W,0,0,ae,Ee,_e):t.texImage2D(i.TEXTURE_2D,W,Ue,ae,Ee,_e);y.generateMipmaps=!1}else if(He){if(mt){const W=we(ne);t.texStorage2D(i.TEXTURE_2D,ce,Ue,W.width,W.height)}I&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ae,Ee,ne)}else t.texImage2D(i.TEXTURE_2D,0,Ue,ae,Ee,ne);m(y)&&h(j),ye.__version=$.version,y.onUpdate&&y.onUpdate(y)}w.__version=y.version}function ee(w,y,z){if(y.image.length!==6)return;const j=nt(w,y),J=y.source;t.bindTexture(i.TEXTURE_CUBE_MAP,w.__webglTexture,i.TEXTURE0+z);const $=n.get(J);if(J.version!==$.__version||j===!0){t.activeTexture(i.TEXTURE0+z);const ye=Qe.getPrimaries(Qe.workingColorSpace),re=y.colorSpace===ki?null:Qe.getPrimaries(y.colorSpace),fe=y.colorSpace===ki||ye===re?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,y.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,y.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,fe);const Ke=y.isCompressedTexture||y.image[0].isCompressedTexture,ne=y.image[0]&&y.image[0].isDataTexture,ae=[];for(let Z=0;Z<6;Z++)!Ke&&!ne?ae[Z]=_(y.image[Z],!0,s.maxCubemapSize):ae[Z]=ne?y.image[Z].image:y.image[Z],ae[Z]=ht(y,ae[Z]);const Ee=ae[0],Ue=r.convert(y.format,y.colorSpace),_e=r.convert(y.type),tt=E(y.internalFormat,Ue,_e,y.colorSpace),He=y.isVideoTexture!==!0,mt=$.__version===void 0||j===!0,I=J.dataReady;let ce=L(y,Ee);qe(i.TEXTURE_CUBE_MAP,y);let W;if(Ke){He&&mt&&t.texStorage2D(i.TEXTURE_CUBE_MAP,ce,tt,Ee.width,Ee.height);for(let Z=0;Z<6;Z++){W=ae[Z].mipmaps;for(let he=0;he<W.length;he++){const ue=W[he];y.format!==wn?Ue!==null?He?I&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,he,0,0,ue.width,ue.height,Ue,ue.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,he,tt,ue.width,ue.height,0,ue.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):He?I&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,he,0,0,ue.width,ue.height,Ue,_e,ue.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,he,tt,ue.width,ue.height,0,Ue,_e,ue.data)}}}else{if(W=y.mipmaps,He&&mt){W.length>0&&ce++;const Z=we(ae[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,ce,tt,Z.width,Z.height)}for(let Z=0;Z<6;Z++)if(ne){He?I&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,ae[Z].width,ae[Z].height,Ue,_e,ae[Z].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,tt,ae[Z].width,ae[Z].height,0,Ue,_e,ae[Z].data);for(let he=0;he<W.length;he++){const Be=W[he].image[Z].image;He?I&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,he+1,0,0,Be.width,Be.height,Ue,_e,Be.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,he+1,tt,Be.width,Be.height,0,Ue,_e,Be.data)}}else{He?I&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,Ue,_e,ae[Z]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,tt,Ue,_e,ae[Z]);for(let he=0;he<W.length;he++){const ue=W[he];He?I&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,he+1,0,0,Ue,_e,ue.image[Z]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,he+1,tt,Ue,_e,ue.image[Z])}}}m(y)&&h(i.TEXTURE_CUBE_MAP),$.__version=J.version,y.onUpdate&&y.onUpdate(y)}w.__version=y.version}function xe(w,y,z,j,J,$){const ye=r.convert(z.format,z.colorSpace),re=r.convert(z.type),fe=E(z.internalFormat,ye,re,z.colorSpace),Ke=n.get(y),ne=n.get(z);if(ne.__renderTarget=y,!Ke.__hasExternalTextures){const ae=Math.max(1,y.width>>$),Ee=Math.max(1,y.height>>$);J===i.TEXTURE_3D||J===i.TEXTURE_2D_ARRAY?t.texImage3D(J,$,fe,ae,Ee,y.depth,0,ye,re,null):t.texImage2D(J,$,fe,ae,Ee,0,ye,re,null)}t.bindFramebuffer(i.FRAMEBUFFER,w),Le(y)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,j,J,ne.__webglTexture,0,Ye(y)):(J===i.TEXTURE_2D||J>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,j,J,ne.__webglTexture,$),t.bindFramebuffer(i.FRAMEBUFFER,null)}function le(w,y,z){if(i.bindRenderbuffer(i.RENDERBUFFER,w),y.depthBuffer){const j=y.depthTexture,J=j&&j.isDepthTexture?j.type:null,$=x(y.stencilBuffer,J),ye=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,re=Ye(y);Le(y)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,re,$,y.width,y.height):z?i.renderbufferStorageMultisample(i.RENDERBUFFER,re,$,y.width,y.height):i.renderbufferStorage(i.RENDERBUFFER,$,y.width,y.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,ye,i.RENDERBUFFER,w)}else{const j=y.textures;for(let J=0;J<j.length;J++){const $=j[J],ye=r.convert($.format,$.colorSpace),re=r.convert($.type),fe=E($.internalFormat,ye,re,$.colorSpace),Ke=Ye(y);z&&Le(y)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Ke,fe,y.width,y.height):Le(y)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Ke,fe,y.width,y.height):i.renderbufferStorage(i.RENDERBUFFER,fe,y.width,y.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Pe(w,y){if(y&&y.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,w),!(y.depthTexture&&y.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const j=n.get(y.depthTexture);j.__renderTarget=y,(!j.__webglTexture||y.depthTexture.image.width!==y.width||y.depthTexture.image.height!==y.height)&&(y.depthTexture.image.width=y.width,y.depthTexture.image.height=y.height,y.depthTexture.needsUpdate=!0),Y(y.depthTexture,0);const J=j.__webglTexture,$=Ye(y);if(y.depthTexture.format===fr)Le(y)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,J,0,$):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,J,0);else if(y.depthTexture.format===Cr)Le(y)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,J,0,$):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,J,0);else throw new Error("Unknown depthTexture format")}function Ie(w){const y=n.get(w),z=w.isWebGLCubeRenderTarget===!0;if(y.__boundDepthTexture!==w.depthTexture){const j=w.depthTexture;if(y.__depthDisposeCallback&&y.__depthDisposeCallback(),j){const J=()=>{delete y.__boundDepthTexture,delete y.__depthDisposeCallback,j.removeEventListener("dispose",J)};j.addEventListener("dispose",J),y.__depthDisposeCallback=J}y.__boundDepthTexture=j}if(w.depthTexture&&!y.__autoAllocateDepthBuffer){if(z)throw new Error("target.depthTexture not supported in Cube render targets");Pe(y.__webglFramebuffer,w)}else if(z){y.__webglDepthbuffer=[];for(let j=0;j<6;j++)if(t.bindFramebuffer(i.FRAMEBUFFER,y.__webglFramebuffer[j]),y.__webglDepthbuffer[j]===void 0)y.__webglDepthbuffer[j]=i.createRenderbuffer(),le(y.__webglDepthbuffer[j],w,!1);else{const J=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,$=y.__webglDepthbuffer[j];i.bindRenderbuffer(i.RENDERBUFFER,$),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,$)}}else if(t.bindFramebuffer(i.FRAMEBUFFER,y.__webglFramebuffer),y.__webglDepthbuffer===void 0)y.__webglDepthbuffer=i.createRenderbuffer(),le(y.__webglDepthbuffer,w,!1);else{const j=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,J=y.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,J),i.framebufferRenderbuffer(i.FRAMEBUFFER,j,i.RENDERBUFFER,J)}t.bindFramebuffer(i.FRAMEBUFFER,null)}function Oe(w,y,z){const j=n.get(w);y!==void 0&&xe(j.__webglFramebuffer,w,w.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),z!==void 0&&Ie(w)}function $e(w){const y=w.texture,z=n.get(w),j=n.get(y);w.addEventListener("dispose",A);const J=w.textures,$=w.isWebGLCubeRenderTarget===!0,ye=J.length>1;if(ye||(j.__webglTexture===void 0&&(j.__webglTexture=i.createTexture()),j.__version=y.version,o.memory.textures++),$){z.__webglFramebuffer=[];for(let re=0;re<6;re++)if(y.mipmaps&&y.mipmaps.length>0){z.__webglFramebuffer[re]=[];for(let fe=0;fe<y.mipmaps.length;fe++)z.__webglFramebuffer[re][fe]=i.createFramebuffer()}else z.__webglFramebuffer[re]=i.createFramebuffer()}else{if(y.mipmaps&&y.mipmaps.length>0){z.__webglFramebuffer=[];for(let re=0;re<y.mipmaps.length;re++)z.__webglFramebuffer[re]=i.createFramebuffer()}else z.__webglFramebuffer=i.createFramebuffer();if(ye)for(let re=0,fe=J.length;re<fe;re++){const Ke=n.get(J[re]);Ke.__webglTexture===void 0&&(Ke.__webglTexture=i.createTexture(),o.memory.textures++)}if(w.samples>0&&Le(w)===!1){z.__webglMultisampledFramebuffer=i.createFramebuffer(),z.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let re=0;re<J.length;re++){const fe=J[re];z.__webglColorRenderbuffer[re]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,z.__webglColorRenderbuffer[re]);const Ke=r.convert(fe.format,fe.colorSpace),ne=r.convert(fe.type),ae=E(fe.internalFormat,Ke,ne,fe.colorSpace,w.isXRRenderTarget===!0),Ee=Ye(w);i.renderbufferStorageMultisample(i.RENDERBUFFER,Ee,ae,w.width,w.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+re,i.RENDERBUFFER,z.__webglColorRenderbuffer[re])}i.bindRenderbuffer(i.RENDERBUFFER,null),w.depthBuffer&&(z.__webglDepthRenderbuffer=i.createRenderbuffer(),le(z.__webglDepthRenderbuffer,w,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if($){t.bindTexture(i.TEXTURE_CUBE_MAP,j.__webglTexture),qe(i.TEXTURE_CUBE_MAP,y);for(let re=0;re<6;re++)if(y.mipmaps&&y.mipmaps.length>0)for(let fe=0;fe<y.mipmaps.length;fe++)xe(z.__webglFramebuffer[re][fe],w,y,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+re,fe);else xe(z.__webglFramebuffer[re],w,y,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+re,0);m(y)&&h(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ye){for(let re=0,fe=J.length;re<fe;re++){const Ke=J[re],ne=n.get(Ke);t.bindTexture(i.TEXTURE_2D,ne.__webglTexture),qe(i.TEXTURE_2D,Ke),xe(z.__webglFramebuffer,w,Ke,i.COLOR_ATTACHMENT0+re,i.TEXTURE_2D,0),m(Ke)&&h(i.TEXTURE_2D)}t.unbindTexture()}else{let re=i.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(re=w.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(re,j.__webglTexture),qe(re,y),y.mipmaps&&y.mipmaps.length>0)for(let fe=0;fe<y.mipmaps.length;fe++)xe(z.__webglFramebuffer[fe],w,y,i.COLOR_ATTACHMENT0,re,fe);else xe(z.__webglFramebuffer,w,y,i.COLOR_ATTACHMENT0,re,0);m(y)&&h(re),t.unbindTexture()}w.depthBuffer&&Ie(w)}function Ze(w){const y=w.textures;for(let z=0,j=y.length;z<j;z++){const J=y[z];if(m(J)){const $=b(w),ye=n.get(J).__webglTexture;t.bindTexture($,ye),h($),t.unbindTexture()}}}const Mt=[],F=[];function It(w){if(w.samples>0){if(Le(w)===!1){const y=w.textures,z=w.width,j=w.height;let J=i.COLOR_BUFFER_BIT;const $=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ye=n.get(w),re=y.length>1;if(re)for(let fe=0;fe<y.length;fe++)t.bindFramebuffer(i.FRAMEBUFFER,ye.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,ye.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,ye.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ye.__webglFramebuffer);for(let fe=0;fe<y.length;fe++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(J|=i.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(J|=i.STENCIL_BUFFER_BIT)),re){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ye.__webglColorRenderbuffer[fe]);const Ke=n.get(y[fe]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Ke,0)}i.blitFramebuffer(0,0,z,j,0,0,z,j,J,i.NEAREST),l===!0&&(Mt.length=0,F.length=0,Mt.push(i.COLOR_ATTACHMENT0+fe),w.depthBuffer&&w.resolveDepthBuffer===!1&&(Mt.push($),F.push($),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,F)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Mt))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),re)for(let fe=0;fe<y.length;fe++){t.bindFramebuffer(i.FRAMEBUFFER,ye.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.RENDERBUFFER,ye.__webglColorRenderbuffer[fe]);const Ke=n.get(y[fe]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,ye.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.TEXTURE_2D,Ke,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ye.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&l){const y=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[y])}}}function Ye(w){return Math.min(s.maxSamples,w.samples)}function Le(w){const y=n.get(w);return w.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&y.__useRenderToTexture!==!1}function Re(w){const y=o.render.frame;u.get(w)!==y&&(u.set(w,y),w.update())}function ht(w,y){const z=w.colorSpace,j=w.format,J=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||z!==nn&&z!==ki&&(Qe.getTransfer(z)===ft?(j!==wn||J!==wi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",z)),y}function we(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(c.width=w.naturalWidth||w.width,c.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(c.width=w.displayWidth,c.height=w.displayHeight):(c.width=w.width,c.height=w.height),c}this.allocateTextureUnit=k,this.resetTextureUnits=O,this.setTexture2D=Y,this.setTexture2DArray=X,this.setTexture3D=Q,this.setTextureCube=H,this.rebindTextures=Oe,this.setupRenderTarget=$e,this.updateRenderTargetMipmap=Ze,this.updateMultisampleRenderTarget=It,this.setupDepthRenderbuffer=Ie,this.setupFrameBufferTexture=xe,this.useMultisampledRTT=Le}function SS(i,e){function t(n,s=ki){let r;const o=Qe.getTransfer(s);if(n===wi)return i.UNSIGNED_BYTE;if(n===Xu)return i.UNSIGNED_SHORT_4_4_4_4;if(n===qu)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Dh)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Ch)return i.BYTE;if(n===Ph)return i.SHORT;if(n===yo)return i.UNSIGNED_SHORT;if(n===Wu)return i.INT;if(n===Ds)return i.UNSIGNED_INT;if(n===Gn)return i.FLOAT;if(n===Io)return i.HALF_FLOAT;if(n===Lh)return i.ALPHA;if(n===Ih)return i.RGB;if(n===wn)return i.RGBA;if(n===Uh)return i.LUMINANCE;if(n===Nh)return i.LUMINANCE_ALPHA;if(n===fr)return i.DEPTH_COMPONENT;if(n===Cr)return i.DEPTH_STENCIL;if(n===Yu)return i.RED;if(n===Ku)return i.RED_INTEGER;if(n===Fh)return i.RG;if(n===ju)return i.RG_INTEGER;if(n===$u)return i.RGBA_INTEGER;if(n===Ma||n===Ta||n===ba||n===Ea)if(o===ft)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Ma)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Ta)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===ba)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Ea)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Ma)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Ta)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===ba)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Ea)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===wc||n===Ac||n===Rc||n===Cc)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===wc)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Ac)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Rc)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Cc)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Pc||n===Dc||n===Lc)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Pc||n===Dc)return o===ft?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Lc)return o===ft?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Ic||n===Uc||n===Nc||n===Fc||n===Oc||n===Bc||n===kc||n===zc||n===Vc||n===Gc||n===Hc||n===Wc||n===Xc||n===qc)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Ic)return o===ft?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Uc)return o===ft?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Nc)return o===ft?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Fc)return o===ft?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Oc)return o===ft?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Bc)return o===ft?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===kc)return o===ft?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===zc)return o===ft?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Vc)return o===ft?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Gc)return o===ft?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Hc)return o===ft?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Wc)return o===ft?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Xc)return o===ft?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===qc)return o===ft?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===wa||n===Yc||n===Kc)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===wa)return o===ft?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Yc)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Kc)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Oh||n===jc||n===$c||n===Zc)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===wa)return r.COMPRESSED_RED_RGTC1_EXT;if(n===jc)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===$c)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Zc)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Rr?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class MS extends en{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class ii extends vt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const TS={type:"move"};class Yl{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new ii,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new ii,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new M,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new M),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new ii,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new M,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new M),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let s=null,r=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const _ of e.hand.values()){const m=t.getJointPose(_,n),h=this._getHandJoint(c,_);m!==null&&(h.matrix.fromArray(m.transform.matrix),h.matrix.decompose(h.position,h.rotation,h.scale),h.matrixWorldNeedsUpdate=!0,h.jointRadius=m.radius),h.visible=m!==null}const u=c.joints["index-finger-tip"],d=c.joints["thumb-tip"],f=u.position.distanceTo(d.position),p=.02,g=.005;c.inputState.pinching&&f>p+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&f<=p-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(r=t.getPose(e.gripSpace,n),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(s=t.getPose(e.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(a.matrix.fromArray(s.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,s.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(s.linearVelocity)):a.hasLinearVelocity=!1,s.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(s.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(TS)))}return a!==null&&(a.visible=s!==null),l!==null&&(l.visible=r!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new ii;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const bS=`
void main() {
