...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:zi,depthTest:!1,depthWrite:!1})}function ah(){return new Xi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:$u(),fragmentShader:`
		...
		`,blending:zi,depthTest:!1,depthWrite:!1})}function lh(){return new Xi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:$u(),fragmentShader:`
...
`)+`
`+f);const b=T+m+o,x=T+f+a,P=gh(s,s.VERTEX_SHADER,b),R=gh(s,s.FRAGMENT_SHADER,x);s.attachShader(_,P),s.attachShader(_,R),t.index0AttributeName!==void 0?s.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function A(C){if(i.debug.checkShaderErrors){const I=s.getProgramInfoLog(_).trim(),L=s.getShaderInfoLog(P).trim(),F=s.getShaderInfoLog(R).trim();let Y=!0,H=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(Y=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,_,P,R);else{const W=xh(s,P,"vertex"),V=xh(s,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
